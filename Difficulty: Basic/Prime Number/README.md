<h2><a href="https://www.geeksforgeeks.org/problems/prime-number2314/1?ref=gcse_ind">Prime Number</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given a number <strong>n</strong>, determine whether it is a prime number or not. </span></p>
